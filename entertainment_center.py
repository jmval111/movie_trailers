...
akira = media.Movie("Akira", "A gang leader must save Tokyo " +
                    "from his transformed friend.",
                    "https://upload.wikimedia.org/wikipedia" +
                    "/en/5/5d/AKIRA_%281988_poster%29.jpg",
                    "https://www.youtube.com/watch?v=-UhLderbuGI")

ghost_shell = media.Movie("Ghost in the Shell",
                          "Man and machine meld in this " +
                          "brilliant futurescape.",
                          "https://www.movieposter.com/posters/" +
                          "archive/main/22/A70-11369  # noqa",
                          "https://www.youtube.com/watch?v=oP2Pt6m3yKU")

powaqqatsi = media.Movie("Powaqqatsi",
                         "Life is shown in elapsed time.",
                         "https://upload.wikimedia.org/wikipedia/fi" +
                         "/1/14/Powaqqatsi-elokuvajuliste.jpg",
                         "https://www.youtube.com/watch?v=fQxZ2oWvXB4")

koyaanisqatsi = media.Movie("Koyaanisqatsi",
                            "Modern life is " +
                            "potrayed.",
                            "https://image.tmdb.org/t/p/w1280/oPr0osF" +
                            "yj81aGlRVQqhW7nq1D0a.jpg",
                            "https://www.youtube.com/watch?v=1jM2WA2WbDc")

odyssey = media.Movie("2001: A Space " +
                      "Odyssey",
                      "An alien artifact communicates " +
                      "with humans throughout time.",
                      "http://www.reelviews.net/resources/img/posters/" +
                      "thumbs/2001_poster.jpg",
